                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                @foreach($requested as $request)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {!! Form::open(['route' => ['user.orders.accept' , $request->id] , $request->book->id]) !!}
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                @foreach($accepted as $accept)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {!! Form::open(['route' => ['user.orders.served' , $accept->id] , $accept->book->id]) !!}
                                                            {!! Form::submit('Served' , ['class' => 'btn btn-primary']) !!}
                                                            {!! Form::close() !!}
                                                        </td>
                                                        <td>
